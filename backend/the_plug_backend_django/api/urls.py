...
urlpatterns = [
    ...
    path('meeting/<int:pk>/', views.MeetingRetrieveUpdateDestroy.as_view(),
    ...
    path('chosen-offer/<int:pk>/', views.ChosenOfferRetrieveUpdateDestroy.as_view(),
         name='chosen-offer-retrieve-update-destroy-view'),
